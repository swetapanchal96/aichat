...
export default function ChatWidget() {
    const { isOpen, setIsOpen, openChat, closeChat } = useChat();
                ...
                <AnimatePresence mode="wait">
                    {isOpen ? (
                        <motion.div
                            ...
                            className="w-95 h-130 rounded-[2.8rem] shadow-[0_40px_80px_-15px_rgba(44,68,107,0.4)] border border-white/20 overflow-hidden flex flex-col origin-bottom-right relative bg-linear-to-b from-primary via-secondary to-[#1a2a44]"
                        >
