...
const UltimateCustomerLogin = () => {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-[#05070a] overflow-hidden font-sans relative">
      ...
      <div className="relative z-10 w-full max-w-[1400px] flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20">
        <div className="hidden lg:block w-1/2 text-white space-y-8">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
            <IoFingerPrintOutline className="text-accent text-lg" />
            <span className="text-[10px] uppercase tracking-[0.3em] font-bold">
        ...
        <div className="w-full max-w-[480px] relative group">
          ...
          <div className="relative bg-[#0d1117]/90 border border-white/10 backdrop-blur-3xl rounded-[2.5rem] p-8 md:p-10 shadow-2xl">
            {/* Home button */}
            <div className="flex justify-between items-center mb-8">
              <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-gray-300 hover:bg-white hover:text-black transition-all"
              >
            ...
            <div className="mt-5 pt-4 border-t border-white/5 flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-2">
                <Link
                  href="/customer/forgot-password"
                  className="group relative text-accent text-[10px] font-bold uppercase tracking-[0.2em] transition-all overflow-hidden"
                >
                  <span className="block pb-1">Lost Keys? / Reset Access</span>
                  <div className="absolute bottom-0 left-0 w-full h-[1.5px] bg-white -translate-x-[101%] group-hover:translate-x-0 transition-transform duration-500"></div>
                </Link>
