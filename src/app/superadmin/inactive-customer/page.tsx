          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Monitor and toggle access for business clients.
              </p>
            </div>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50/50">
                    ...
                    <th className="px-6 py-4 text-[10px] uppercase tracking-widest font-bold text-gray-400 text-center">
                      Status Action
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-gray-50">
                  {loading ? (
                    ...
                    filteredCustomers.map((item, index) => (
                      <tr key={item.company_id} className="hover:bg-accent/5 transition-colors group">
